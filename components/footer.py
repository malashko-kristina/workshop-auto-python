...
class Footers:
    def __init__(self, actions: PageAction):
        ...
        self.copyright_text = (
            '.greyNote >> text="Copyright' ' © 2006–2024 JetBrains s.r.o."'
        )
        self.about_button = 'a[data-test="ring-link"] >> text="About TeamCity"'
        self.license_agreement_button = (
            'a[data-test="ring-link"] >> text="License Agreement"'
        )
    ...
    def check_copyright_text_is_visible(self):
        ...
        self.actions.assert_text_in_element(
            self.copyright_text, "Copyright © 2006–2024" " JetBrains s.r.o."
        )
