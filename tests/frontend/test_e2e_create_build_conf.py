...
def test_create_build_conf_with_invalid_data(browser, project_data, super_admin, build_conf_data, delete_all_projects):
    ...
    with allure.step("Создание билд конфигурации с невалидным id"):
        build_conf_error.create_build_conf(invalid_build_id, build_conf_name, str(invalid_build_id[0]))
        build_conf_error.check_error_invalid_build_id(invalid_build_id, str(invalid_build_id[0]))
...
def test_create_invalid_copy_build_conf(browser, project_data, super_admin, build_conf_data_without_deleting_id, project_data_first_project):
    ...
    with allure.step("Копирование билд конфигурации с невалидным id"):
        ...
        edit_build_conf.check_error_message_build_copy(invalid_build_id, str(invalid_build_id[0]))
    with allure.step("Удаление билд конфигурации"):
