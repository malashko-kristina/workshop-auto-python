...
class DataGenerator:
    ...
    def fake_project_id():
        ...
        rest_characters = "".join(
            faker_instance.random.choices(
    ...
    @staticmethod
    def fake_build_id():
        first_letter_build = (faker_instance.random.choice
                              (string.ascii_letters))
        rest_characters_build = "".join(
            faker_instance.random.choices(string.ascii_letters +
                                          string.digits, k=10)
        )
    ...
    @staticmethod
    def fake_emaiL():
        first_letter_email = (faker_instance.random.choice
                              (string.ascii_letters))
        first_part_email = "".join(
            faker_instance.random.choices(
                string.ascii_letters + string.digits + "_" + ".", k=9
            )
        )
        second_part_email = "".join(
            faker_instance.random.choices(string.ascii_letters, k=4)
        )
        third_part_email = "".join(
            faker_instance.random.choices(string.ascii_letters, k=3)
        )
        generated_email = (
            f"{first_letter_email}{first_part_email}"
    ...
    def incorrect_id_1():
        ...
        special_symbol = (faker_instance.random.choice
                          ("@#$%^&*"))
        first_part_symbols = "".join(
            faker_instance.random.choices(string.digits +
                                          special_symbol, k=4)
        )
        second_part_symbols = "".join(
            faker_instance.random.choices(string.ascii_letters, k=7)
        )
