...
class BuildConfEditFragment(BasePage):
    def __init__(self, page):
        ...
        self.copy_button = ('.menuItem >> text='
                            '"Copy configuration..."')
        ...
        self.cancel_button = ('#copyBuildTypeFormDialog'
                              ' > div.modalDialogBody >'
    ...
    def message_after_copy_build_conf(self):
        ...
        self.actions.assert_text_in_element(self.copy_build_message,
                                            f'Build configuration has been'
    ...
    def error_message_copy_build_conf(self, build_conf_id, first_symbol):
        with allure.step("Проверка отображения текста ошибки копировании билда"):
            ...
            self.actions.assert_text_in_element(self.error_message_id,
    ...
    def message_after_delete_build_conf(self, build_conf_name):
        with allure.step("Проверка сообщения об удалении билд конфигурации"):
            ...
            self.actions.assert_text_in_element(self.delete_build_conf_message,
