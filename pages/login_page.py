...
class LoginFormBody(BasePage):
    ...
    def input_user_details(self, login, password):
        with allure.step("User data entry"):
    ...
    def click_login_button(self):
        with allure.step("Click on the login button to log in"):
    ...
    def userpic_is_visible(self):
        with allure.step("Checking userpic visibility"):
...
class LoginPage(BasePage):
    ...
    def check_url_favourite_projects_mode(self):
        with allure.step("Check a page by url"):
    ...
    def check_url_favourite_projects(self):
        ...
        with allure.step(
            "Check the transition by url (for the very first project)"
        ):
            self.actions.check_url(self.page_url, equal=False)
    ...
    def login_in_account(self, login, password):
        ...
        with allure.step("Click on the login button to your account"):
